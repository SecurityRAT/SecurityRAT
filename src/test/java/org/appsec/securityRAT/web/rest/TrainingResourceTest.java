...
public class TrainingResourceTest {
    ...
    private static final DateTime DEFAULT_LAST_MODIFIED = new DateTime(0L, DateTimeZone.UTC);
    private static final DateTime UPDATED_LAST_MODIFIED = new DateTime(DateTimeZone.UTC).withMillisOfSecond(0);
    private static final String DEFAULT_LAST_MODIFIED_STR = dateTimeFormatter.print(DEFAULT_LAST_MODIFIED);
    ...
    public void initTest() {
        ...
        training.setLast_modified(DEFAULT_LAST_MODIFIED);
    }
    ...
    public void createTraining() throws Exception {
        ...
        assertThat(testTraining.getLast_modified().toDateTime(DateTimeZone.UTC)).isEqualTo(DEFAULT_LAST_MODIFIED);
    }
    ...
    public void updateTraining() throws Exception {
        ...
        training.setLast_modified(UPDATED_LAST_MODIFIED);
        ...
        assertThat(testTraining.getLast_modified().toDateTime(DateTimeZone.UTC)).isEqualTo(UPDATED_LAST_MODIFIED);
    }
